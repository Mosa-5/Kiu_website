...
export const aboutData: aboutData = {
  intro: {
    ...
    signature: {
      ...
      title: "Founder of Kutaisi International University",
  ...
  president: {
    ...
    subtitle: "Prof. Dr. Wolfgang A. Herrmann",
    greeting: "Welcome to Kutaisi International University!",
    paragraphs: [
      ...
      "Based on my 24-years' experience as President of Technical University of Munich (TUM), I am glad to support the upcoming Kutaisi International University and to help establish international cooperation in scientific research and technology. The basic concept of KIU aims at the interchange of expertise and mutual talent to make Kutaisi a stronghold of Georgian science and entrepreneurship to the benefit of the country and its prosperous economic future. The alliance with TUM should open new horizons particularly in engineering and to create new industries in the Caucasian area.",
