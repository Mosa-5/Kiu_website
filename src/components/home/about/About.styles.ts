...
export const container = cva(
  "max-sm:flex-col-reverse sm:max-w-[1494px] flex justify-between items-center gap-6 sm:gap-[90px] mx-auto sm:mb-[181px]"
);
...
export const mainTitle = cva("text-main font-semibold text-2xl sm:text-[40px]");

export const subtitle = cva(
  "text-main font-medium text-[16px] sm:text-2xl mb-6 sm:mb-10"
);

export const textContent = cva("text-sm sm:text-lg space-y-4 mb-6 sm:mb-10");
...
export const readMoreButton = cva(
  "max-sm:w-full bg-mainLight w-40 h-12 shadow-[2px_3px_4px_0px_#00000040] font-medium text-lg hover:bg-main hover:cursor-pointer"
);
