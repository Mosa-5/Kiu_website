...
const NewsCarousel: React.FC<{
  ...
  return (
    ...
    >
      ...
      <CarouselPrevious className={carouselButton()} aria-label="Previous video" title="Previous video" />
      <CarouselNext className={carouselButton()} aria-label="Next video" title="Next video" />
    </Carousel>
  );
};
