...
export const headerSectionVariants = cva("w-full mb-10");

export const titleVariants = cva(
  "text-[40px] text-main font-semibold w-fit rounded-xl py-1 px-5"
);

export const gridVariants = cva("grid grid-cols-2 gap-6");
