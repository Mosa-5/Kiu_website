...
export const footerContainer = cva("w-full bg-[#192735] mt-16 sm:mt-36 sm:max-3xl:mt-28");

export const footerContent = cva(
  "sm:h-[403px] sm:max-3xl:h-auto px-4 sm:px-[120px] sm:max-3xl:px-16 pb-12 pt-8 sm:py-[80px] sm:max-3xl:py-14"
);
...
export const linksContainer = cva(
  "flex max-sm:flex-col max-w-[686px] gap-7 sm:gap-[77px] sm:max-3xl:gap-12"
);
...
export const sectionTitle = cva(
  "font-medium text-2xl sm:text-[32px] sm:max-3xl:text-[26px] text-[#FAF9F6] mb-5 sm:mb-[32px] sm:max-3xl:mb-6 whitespace-normal"
);
...
export const footerBottom = cva(
  "sm:h-[72px] p-4 sm:px-[120px] sm:max-3xl:px-16 sm:py-[24px] w-full bg-[#15222E]"
);
