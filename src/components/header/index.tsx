...
const Header = () => {
  ...
  return (
    <div
      className={`flex items-center z-10 justify-center fixed left-1/2 -translate-x-1/2 border-1  rounded-2xl w-full max-w-[1680px] h-[80px] bg-[#FFFFFFE5] transition-all duration-200 ${
        scrolled
