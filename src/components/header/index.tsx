...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 200) { // threshold in pixels
        setScrolled(true);
      } else {
        setScrolled(false);
      }
...
return <div className={`z-50 flex items-center justify-center fixed left-1/2 -translate-x-1/2 border-1  rounded-2xl w-full max-w-[1680px] h-[80px] bg-[#FFFFFFE5] transition-all duration-200 ${scrolled ? "max-w-full border-b-2 border-t-0 border-b-[#3C70AF] rounded-none top-[0px] bg-white":"max-w-[1680px] top-[24px] shadow-[2px_4px_4px_0px_#00000040] "}`}>
