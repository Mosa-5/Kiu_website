...
export const description = cva("text-md sm:max-3xl:text-sm max-w-[80%] text-center");
...
export const title = cva(
  "text-white font-semibold text-xl sm:text-2xl sm:max-3xl:text-xl text-center backdrop-blur-[1px] flex rounded-full"
);
