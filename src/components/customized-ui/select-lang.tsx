  ...
  return (
    ...
    >
      ...
      <SelectContent className="w-[118px] font-[500] text-[#3C70AF]">
        <SelectItem
          className="border-x-2 border-transparent rounded-none hover:border-l-[#3C70AF] focus:text-inherit text-lg flex justify-center [&>span[data-slot=select-item-indicator]]:hidden [&>span.absolute]:hidden"
          value="ka"
        >
