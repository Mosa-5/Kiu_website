...
export const sectionHeader = cva(
  ["bg-headingBg items-center gap-3 sm:max-3xl:gap-2 px-4 sm:max-3xl:px-3 py-2 sm:max-3xl:py-1.5 rounded mb-6 sm:max-3xl:mb-4"],
  {
    variants: {
      centered: {
...
export const programList = cva(["list-none mb-6 sm:max-3xl:mb-4 text-sm sm:text-lg sm:max-3xl:text-base space-y-4 sm:max-3xl:space-y-3"]);
...
export const sectioncalendar = cva(
  ["mb-12 sm:max-3xl:mb-8 scroll-mt-8 flex items-center justify-center flex-col"],
  {
    variants: {
      isFirst: {
        true: ["scroll-mt-0"],
