...
const tuitionAndCostsKa: ProgramData["tuitionAndCosts"] = {
  ...
  points: [
    "სწავლების საფასური 5,500 ევროს ტოლია, საქართველოს ეროვნული ბანკის მიერ გადახდის დღეს დადგენილი გაცვლითი კურსის შესაბამისად. (საფასური მოიცავს ყველა სასწავლო მასალას);",
