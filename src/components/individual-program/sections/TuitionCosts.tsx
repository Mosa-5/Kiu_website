  ...
  return (
    <section id="tuition-costs" className="mb-12 scroll-mt-8">
      <div className="bg-[#E3F0FF] inline-flex items-center gap-3 px-4 py-2 rounded mb-6">
        ...
        <span className="text-[#1B3D6E]">{CostsIcon}</span>
      </div>

      <h3 className="text-2xl font-medium text-main mb-6">{data.academicYear}</h3>
      ...
      <p className="text-lg">
        ...
        <a href={data.admissionNote.linkUrl} className="text-main hover:underline font-medium">
