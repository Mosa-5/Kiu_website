...
const AboutProgramSection: React.FC<Props> = ({ programData }) => {
  ...
  return (
    <section id="about-program" className="mb-12 scroll-mt-8">
      ...
      <h3 className="text-2xl font-medium text-main mb-3">
      ...
      {data.learningOutcomes.sections.map((s, i) => (
        <div key={i} className="mb-4">
          {s.subtitle && (
            <h4 className="font-medium text-lg mb-2">• {s.subtitle}</h4>
          )}
      ...
      <h3 className="text-2xl font-medium text-main mb-3 mt-6">
